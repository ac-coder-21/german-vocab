...
export function NewOppositeSetForm({ nextSetNumber }: { nextSetNumber: number }) {
    ...
    <form ref={formRef} action={formAction} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-3">
        {rows.map((id) => (
          ...
          >
            <input name="word" placeholder="Word (e.g. groß)" className={fieldClass} />
            <input
              name="opposite"
              placeholder="Opposite (e.g. klein)"
