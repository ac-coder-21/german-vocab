...
import { NewAdjectiveSetForm } from "@/components/adjectives/new-adjective-set-form";
import { EditAdjectiveSetPanel } from "@/components/adjectives/edit-adjective-set-panel";
...
export function ManageAdjectiveSets({
  sets,
  selectedSet,
  adjectives,
  nextSetNumber,
      ...
      <div className="relative z-10 flex w-full max-w-2xl flex-col gap-8">
        ...
        >
          ...
          <p className="max-w-md text-balance text-muted-foreground">
            Add a new set of adjectives, or edit and delete words in an
            existing one.
          </p>
        </motion.div>
        ...
        <div className="rounded-2xl border bg-card/70 p-6 shadow-sm backdrop-blur">
          {tab === "new" ? (
            <NewAdjectiveSetForm nextSetNumber={nextSetNumber} />
          ) : (
            <EditAdjectiveSetPanel
              sets={sets}
