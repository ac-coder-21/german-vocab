...
const modes: Mode[] = [
  {
    ...
    href: (setNumbers) => `/categories/nouns/${setNumbers[0]}/learn`,
  },
  {
    key: "test-words",
    title: "Test Words",
    ...
    multiSet: true,
    href: (setNumbers) => `/categories/nouns/${setNumbers.join(",")}/test-words`,
  },
  {
    key: "test-gender",
    title: "Test Gender",
    ...
    multiSet: true,
    href: (setNumbers) => `/categories/nouns/${setNumbers.join(",")}/test-gender`,
  },
];
