...
export function NewOtherWordSetForm({ nextSetNumber }: { nextSetNumber: number }) {
    ...
    <form ref={formRef} action={formAction} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-3">
        {rows.map((id) => (
          ...
          >
            <input name="german" placeholder="German (e.g. und)" className={fieldClass} />
            <input name="english" placeholder="English (e.g. and)" className={fieldClass} />
            <Button
              type="button"
              variant="ghost"
              size="icon"
